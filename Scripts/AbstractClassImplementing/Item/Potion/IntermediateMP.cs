...
{
    PotionItemData intermediateMP;  // 중급 마나 회복 물약 아이템 데이터
    ...
    {
        if (!UsePossible()) throw new System.Exception(intermediateMP.ItemName + " 사용 불가");

        Debug.Log(intermediateMP.ItemName + " 아이템 사용");
